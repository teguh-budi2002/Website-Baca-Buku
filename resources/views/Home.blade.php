                                        ...
                                        <div class="grid grid-cols-2 gap-10 mt-10">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-center mt-8">
                                                    <a href="" class="block py-2 px-10 rounded-full bg-green-600 hover:bg-green-500 text-white not-italic">Hubungi Kami</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full max-h-[600px] p-6 no-scrollbar overflow-y-scroll">
                                        <div class="grid grid-cols-2 gap-10 mt-10">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-center mt-8">
                                                    <a href="https://wa.me/" class="block py-2 px-10 rounded-full bg-green-600 hover:bg-green-500 text-white not-italic">Hubungi Kami</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
